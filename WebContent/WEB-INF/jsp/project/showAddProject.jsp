					...
					<div>
							...
							<br>
								项目描述：<input type="text" name="pro_description" id="pro_description" size="20"   required="required" style="width: 300px;height: 40px; "/>
									<br>
									<br>
								项目地址：<input type="text" name="pro_file" id="pro_file" size="20"   required="required" style="width: 300px;height: 40px;" value="http://"/>
									<br>
									<br>
								<div>
					</div> 
	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="password" name="pro_description" class="form-control"
						type="text" >
				</div>
			</div>
