	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="result_name" name="result_name"  class="form-control" 
						type="text" aria-required="true" value="${result.result_name}" 
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="result_description" name="result_description" class="form-control" 
					 value="${result.result_description}"  style="height: 200px;" type="text" >
				</div>
			</div>
