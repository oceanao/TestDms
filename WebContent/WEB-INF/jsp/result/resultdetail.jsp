...
<body class="gray-bg">
	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			action="${pageContext.request.contextPath }/result/updateresult"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="result_name" name="result_name"  class="form-control" 
						type="text" aria-required="true" value="${result.result_name}" disabled="disabled"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea id="result_description" name="result_description" class="form-control" disabled="disabled"
					  style="height: 200px;" type="text" >${result.result_description}</textarea>
				</div>
			</div>
