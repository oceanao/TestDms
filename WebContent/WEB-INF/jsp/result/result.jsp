				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<a class="close-link" href="${pageContext.request.contextPath }/result/addresult?flag=1" target="_self"
									>新增</a>
						...
						<table
							...
							<tr id="data_${stat.index}" align="center">
								...
								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/result/updateresult?flag=1&result_id=${result.result_id}">
										修改</a></td>
								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/result/removeresult?result_id=${result.result_id}">
										删除</a></td>
								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/result/detailresult?result_id=${result.result_id}">
										详情</a></td>
							</tr>
						</c:forEach>
