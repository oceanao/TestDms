				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<a class="close-link" href="${pageContext.request.contextPath }/ponderance/addponderance?flag=1" target="_self"
									>新增</a>
					...
					<div class="ibox-content">
						...
						<table
							...
							<tr id="data_${stat.index}" align="center">
								<td>${stat.count}</td>
								<td>${ponderance.pon_name }</td>

								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/ponderance/updateponderance?flag=1&pon_id=${ponderance.pon_id}">
										修改</a></td>
								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/ponderance/removeponderance?pon_id=${ponderance.pon_id}">
										删除</a></td>
								<td align="center" width="40px;"><a target="_self"
									href="${pageContext.request.contextPath }/ponderance/detailponderance?pon_id=${ponderance.pon_id}">
										详情</a></td>
							</tr>
						</c:forEach>
