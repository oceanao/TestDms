...
<body class="gray-bg">
	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			action="${pageContext.request.contextPath }/ponderance/updateponderance"
			target="_self" method="post">
			<input type="hidden" name="flag" value="2">
			
			<input type="hidden" name="pon_id" value="${ponderance.pon_id}">
			<div class="form-group">
				<label class="col-sm-3 control-label">缺陷级别名称</label>
				<div class="col-sm-8">
					<input id="pon_name" name="pon_name"  class="form-control" 
						type="text" aria-required="true" value="${ponderance.pon_name }"/> <span
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">缺陷级别描述</label>
				<div class="col-sm-8">
					
				<%-- 	<input id="pon_description" name="pon_description" class="form-control" 
					  style="height: 200px;" type="text"  value="${ponderance.pon_description }"> --%>
					  
					  <textarea id="pon_description" name="pon_description" class="form-control" 
					  style="height: 200px;" type="text">${ponderance.pon_description }</textarea>
				<br>
				</div>
			</div>
