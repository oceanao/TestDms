...
<body style="background-color: rgba(0,0,0,0);">
	...
	<div class="ibox-content" style="background-color: rgba(0,0,0,0);">
		<form class="form-horizontal m-t" id="signupForm"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="pon_name" name="pon_name"  class="form-control" disabled="disabled"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					  ...
					  <textarea id="pon_description" name="pon_description" class="form-control" disabled="disabled"
					  style="background-color: rgba(0,0,0,0);height: 200px;" type="text">${ponderance.pon_description}</textarea>
				<br>
				</div>
			</div>
