					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="${pageContext.request.contextPath }/admin/adduser?flag=1" target="_self"
									>新增</a>
								</li>
								<li><a href="${pageContext.request.contextPath }/admin/statistics" target="_self"
									>图表</a>
								</li>
							</ul>
							<a class="close-link" href="${pageContext.request.contextPath }/admin/adduser?flag=1" target="_self"
									>新增</a>
							...
							<tbody>
								...
								href="${pageContext.request.contextPath }/user?flag=1&user_id=${user.user_id}">
									${user.username }</a></td>
										...
										<td><a target="_self" 
								href="${pageContext.request.contextPath }/admin/updateuser?flag=1&user_id=${user.user_id}">
									修改</a></td>
									<td><a target="_self" onclick="sure()"
								href="${pageContext.request.contextPath }/admin/removeUser?user_id=${user.user_id}">
									删除</a></td>
									</tr>
								</c:forEach>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="table_data_tables.html#" tppabs="http://www.zi-han.net/theme/hplus/table_data_tables.html#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="table_data_tables.html#" tppabs="http://www.zi-han.net/theme/hplus/table_data_tables.html#">选项1</a>
                                </li>
                                <li><a href="table_data_tables.html#" tppabs="http://www.zi-han.net/theme/hplus/table_data_tables.html#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
