...
<body class="gray-bg">
	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			...
			<div class="form-group">
				<a title="查看缺陷状态详细信息"><label class="col-sm-3 control-label" onclick="$('#popup').show();">缺陷状态：</label></a>
				<div class="col-sm-8">
					<select id="bug_status" name="bug_status" class="form-control">
						...
						<c:choose>
							...
							<c:when test="${bug.bug_status == 7 }">
								...
								<option value="4">handled</option>
								<option value="5">Closed</option> -->
								<option value="7" selected="selected">Closed</option>
							</c:when>
							<c:when test="${bug.bug_status == 8 }">
								...
								<option value="4">handled</option>
								<option value="5">Closed</option> -->
								<option value="8" selected="selected">Reopen</option>
							</c:when>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">添加评论：</label>
				<div class="col-sm-8">
					<textarea name="bug_comment" id="bug_comment" required="required"
