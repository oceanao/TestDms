...
<body class="gray-bg">
	...
	<div class="ibox-content">
		<form class="form-horizontal m-t" id="signupForm"
			action="${pageContext.request.contextPath }/Team/addTeam"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="team_name" name="team_name"  class="form-control" 
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="team_description" name="team_description" class="form-control"
						type="text" >
				</div>
			</div>
