				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<a class="close-link" href="${pageContext.request.contextPath }/Team/addTeam?flag=1" target="_self"
									>新增</a>
					...
					<div class="ibox-content">
						...
						<table
							...
							<td><a target="_self" href="${pageContext.request.contextPath }/Team/userlist?team_id=${Team.team_id}">${Team.team_name }</a></td>
							
								<td>${Team.manager.username}</td>
								<td >
								<a target="_self"  href="${pageContext.request.contextPath }/Team/updateTeam?flag=1&team_id=${Team.team_id}">
										修改</a></td>
								<td ><a target="_self"
									href="${pageContext.request.contextPath }/Team/removeTeam?team_id=${Team.team_id}">
										 删除</a></td>
								<td ><a target="_self"
									href="${pageContext.request.contextPath }/Team/detailTeam?team_id=${Team.team_id}"> 
										详情</a></td>
									<td>	
									<a target="_self" href="${pageContext.request.contextPath }/Team/statistics?team_id=${Team.team_id}" title="图表统计">
										图表</a>
										</td>
							</tr>
						</c:forEach>
