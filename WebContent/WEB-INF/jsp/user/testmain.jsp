...
<link
	...
	var picture;
      ...
      　　　　 url:'${pageContext.request.contextPath }/user/photo',
	   ...
	   document.getElementById("myPic").src= "/pic/"+ picture;
</script>
</head>
			...
			<ul class="nav" id="side-menu">
				<li class="nav-header">
					<div class="dropdown profile-element">
						<span><img alt="image" class="img-circle" id="myPic"
							src=" " style="width: 100px;height: 100px;" /></span>
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
							class="clear"> <span class="block m-t-xs"><strong
									class="font-bold">
									测试人员
									</strong></span> <span
								class="text-muted text-xs block">${username}<b class="caret"></b></span>
						</span>
						</a>
				...
				<li><a href="#"> <i class="fa fa-home"></i> <span
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="http://localhost:8084/ManageBugs/user/addBug?flag=1" 
				...
				<li><a class="J_menuItem"
						...
						class="fa fa-magic"></i> <span class="nav-label"></span>查看项目</a>
						</li>
				<li><a class="J_menuItem"
					href="${pageContext.request.contextPath }/user/selectBug"><i
						class="fa fa-magic"></i> <span class="nav-label">查看管理</span></a></li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					...
					frameborder="0" data-id="${pageContext.request.contextPath}/user/selectBug" seamless></iframe>
			</div>
			<div class="footer">
	   ...
	   document.getElementById("myPic").src= "/pic/"+ picture;
				...
				<li><a href="#"><i class="fa fa-table"></i> <span
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="http://localhost:8084/ManageBugs/user/userProject" class="J_menuItem"
							>我的项目</a>
						</li>
					</ul></li>
				<li><a class="J_menuItem"
