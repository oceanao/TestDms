...
public class Email implements Serializable{
	...
	public void email(String receiveMailAccount )
	{
	// 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
    // PS: 某些邮箱服务器为了增加邮箱本身密码的安全性，给 SMTP 客户端设置了独立密码（有的邮箱称为“授权码”）, 
    //     对于开启了独立密码的邮箱, 这里的邮箱密码必需使用这个独立密码（授权码）。
    String myEmailAccount = "18281577265@163.com";
    String myEmailPassword = "ocean0530";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
  /*  String receiveMailAccount = project.getManager().getEmail();*/
...
public  MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
    ...
    // 2. From: 发件人
    message.setFrom(new InternetAddress(sendMail,this.sendperson, "UTF-8"));
